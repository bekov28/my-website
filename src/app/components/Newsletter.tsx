        ...
        <div className="max-w-7xl mx-auto">
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-300 md:w-2/3">
              Get the latest updates on my projects, blog posts and tech insights delivered to your
              inbox.
            </p>
          </div>
          ...
          <form className="flex flex-col md:flex-row gap-4">
            <input
              ...
              className="flex-1 px-4 py-3 border rounded-lg dark:text-white border-gray-300 dark:border-gray-600 bg-white
               text-gray-500 dark:bg-dark focus:outline-none focus:ring-2 focus:ring-primary"
            />
          </form>
        </div>
      </div>
