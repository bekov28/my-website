  ...
  return (
    ...
    >
      ...
      <h2 className="py-15 text-base sm:text-lg md:text-xl leading-10 sm:m-3 text-justify">
        ...
        is HTML, CSS (SCSS), Vanilla JavaScript and Vue.js framework. Besides front-end, I also do
        some backend with Java and Spring Boot (both Gradle and Maven tools) and automate the tasks.
        ...
        learn new technologies and finally contribute to the society as much as I could do. Wheather
